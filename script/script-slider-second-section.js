...
var slider = (function (config) {
  ...
  const ClassName = {
    INDICATOR_ACTIVE: 'slider__indicator_active-second-section',
    ITEM: 'slider__item-second-section',
    ITEM_LEFT: 'slider__item_left-second-section',
    ITEM_RIGHT: 'slider__item_right-second-section',
    ITEM_PREV: 'slider__item_prev-second-section',
    ITEM_NEXT: 'slider__item_next-second-section',
    ITEM_ACTIVE: 'slider__item_active-second-section'
  }
  ...
  selector: '.slider-second-section',
  isCycling: true,
  direction: 'next',
  interval: 5000,
  pause: true
